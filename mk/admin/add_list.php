...
function doRemove(){
	...
	if(chkflag==false){
		...
		if(confirm('삭제하시겠습니까?')){
			document.getElementsByName('cmd')[0].value='action_remove_multi_fake';
			thisform.submit();
		}
	}
}
...
function reLoad(){
	...
	location.href='./index_admin.php?mn1=add&mn2=add_list&sch_cat_01='+sch_cat_01+'&sch_cat_02='+sch_cat_02+'&sch_st_date='+sch_st_date+'&sch_ed_date='+sch_ed_date;
}
</script>
...
<table border='0' width='90%' bordercolor='#b4b4b4' align='center'>
	<tr>
		<td style='padding-bottom:8px;'><font color='#ff8702' size='3px'><b>| 댓글 목록</b></font></td>
	</tr>
	<tr><td>&nbsp;&nbsp;&nbsp;</td></tr>
	<tr>
		<td>
		...
		<td>
			<table border='1' width='100%' bordercolor='#b4b4b4' align='center'>
				<tr>
					...
					<td bgcolor='#ececec' style='width:30px;padding-top:5px; padding-bottom:2px; text-align:center; color:#222222;'>NO</td>
					...
					<td bgcolor='#ececec' style='padding-top:5px; padding-bottom:2px; text-align:center; color:#222222;'>등록자</td>
					<td bgcolor='#ececec' style='padding-top:5px; padding-bottom:2px; text-align:center; color:#222222;'>등록처</td>
				</tr>";
...
foreach($lists as $key=>$val){
	...
	$alink="./index_admin.php?mn1=add&mn2=add_edit&_id=".$val['_id'];
	echo "
				<tr>
					...
					<td style='padding-top:5px; padding-bottom:2px; padding-left:3px; text-align:center;'>".date('Y-m-d H:i',$val['regdate'])."</td>
					<td style='padding-top:5px; padding-bottom:2px; padding-left:3px; text-align:center;'>".$val['user_id']."</td>
					<td style='padding-top:5px; padding-bottom:2px; padding-left:3px; text-align:center;'>".$val['cat_01']." > ".$val['cat_02']."</td>
				</tr>";
}
echo "
			</table>

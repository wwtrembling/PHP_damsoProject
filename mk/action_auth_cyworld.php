...
include($mkadd_dir."cyworld/Mkcyworld.class.php");
$type='cyworld';
...
$cls= new Mkcyworld($_SESSION[$type.'_request_token'], $_SESSION[$type.'_request_token_secret'], $_SESSION[$type.'_access_token'], $_SESSION[$type.'_access_token_secret']);
